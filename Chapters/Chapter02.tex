...
beam~\parencite{Hipp:14,Wang20102}.
We chose to operate the interferometers at the first Lohmann order, since it
has been reported~\parencite{Thuering2014} that a $\pi$ phase shift
achieves a slightly superior visibility with respect to a $\pi/2$ phase shift
at the first order.
On the other hand, the theoretical analysis indicates that a $\pi/2$ \G1
would perform better for higher Lohmann orders.
