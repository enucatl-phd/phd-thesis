...
\begin{figure}[htb]
    ...
    materials.]{Ratio of $\delta$ to $\beta$, tabulated from \cite{nist}.
...
completely predominant above a photon energy of \SI{50}{\kilo\eV}.
...
factor of $\approx\energy^{3.5}$, while each absorption even of course deposits an
...
In the higher energy range, Compton scattering becomes the main source of
...
with increasing energy. Hence, above this energy threshold where Compton
scattering becomes the main source of X-ray interactions, it is no longer
advantageous from the point of view of dose delivery to increase the energy.
...
In all our experiments a phase shift of $\pi$ in the \G1 grating has been
