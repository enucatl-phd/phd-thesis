...
\begin{equation}
    ...
    \partial^2_z}_{=0 \text{ by the\\
    paraxial approximation}} + k^2 (n^2_\omega(\vec{x}) - 1)
...
\begin{figure}[htb]
    ...
    \caption[Propagation-based setup.]{A propagation-based phase contrast
        setup, reproduced from the public domain~\cite{propagation-based-picture}. The intensity modulations producing edge-enhancing effects can
...
\begin{figure}[htb]
    ...
    \caption[Analyzer-based setup.]{A setup for diffraction enhanced
        imaging, reproduced from the public domain~\cite{analyzer-based-picture}. The fine angular deviations introduced in the
...
\begin{figure}[htb]
    ...
    \caption[Bonse-Hart interferometer.]{A Bonse-Hart crystal
        interferometer, reproduced from the public domain~\cite{bonse-hart-picture}. Two coherent beams are created: one is used as a
...
\begin{figure}[htb]
    ...
    \caption[Edge illumination.]{A setup for edge illumination, reproduced
        from the public domain~\cite{edge-illumination-picture}. Angular
