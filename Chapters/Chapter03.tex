...
Another critical factor in~\eqref{eq:variance} is the visibility~$v$. The
...
\begin{aenumerate}
    ...
    \item the width of the spectrum positively contributing to the
        ...
        maximum~\parencite{Thuering2014} of
...
estimated according to the formula from~\cite{Thuering2014} for the visibility as a function
...
function of energy~\parencite{Thuering2014} for a design energy of \SI{100}{\kilo\eV} at the first
...
\begin{table}[htb]
    ...
    \begin{tabular}{*4c}
        \toprule
        grating & \begin{tabular}{@{}c@{}}design\\ energy (\si{\kilo\eV})\end{tabular} & 
        \begin{tabular}{@{}c@{}}curvature\\ radius (\si{\centi\meter})\end{tabular} & thickness (\si{\micro\metre}) \\
        \midrule
        $G_0$ & \num{100}/\num{120} & \num{23} & \num{800} \\
        $G_1$ & \num{100} & \num{38.8} & \num{42.2} \\
        $G_1$ & \num{120} & \num{42.0} & \num{19.4} \\
