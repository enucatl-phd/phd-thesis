...
% ****************************************************************************************************
\newcommand{\myTitle}{Dark-field imaging for hard X-ray grating
interferometry: predictive models and applications\xspace}
%\newcommand{\mySubtitle}{\xspace}
\newcommand{\myDegree}{Dottore magistrale in Fisica, Università degli Studi di Padova\xspace}
...
\DeclareMathOperator{\Fq}{\mathcal{F}_{q}}
...
\newcommand{\cn}[1][]{\textsuperscript{\color{blue} [citation needed: #1]}}
\PassOptionsToPackage{detect-all}{siunitx}		
 \usepackage{siunitx}
\newcommand{\voltpeak}{\volt}
\newcommand{\energy}{\ensuremath{\mathcal{E}}}

\acrodef{CT}{computed tomography}
\acrodef{SEM}{scanning electron microscope}
\acrodef{SNR}{signal-to-noise ratio}
\acrodef{PMMA}{polymethyl methacrylate}
\acrodef{PS}{polystyrene}
\acrodef{HDPE}{high-density polyethylene}
